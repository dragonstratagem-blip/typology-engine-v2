...
Letter-Polerity = Is either + or - before the letter code for the Primer of the Personality Trait Duality.

Influence-Polarity = Is either + or - or nul before the Influence-Magnitude number, where influance is the affect that the primer has on the person's personality.

Influence-Magnitude = Is an range of 1 to 3 for how much the primer influences the person's personality.

Capacity-Polarity = Is either + or - or nul before the Capacity-Magnitude number, where capacity is the affect that the person's personality has on the primer.

Capacity-Magnitude = Is a range of 1 to 6 for how much the person's personality affects the primer. 
